...
function sweetAlert( type, text, url )
{
    ...
    switch ( type ) {
        case 1:
            title = 'Éxito';
            icon = 'check_circle';
            color = 'mdl-color-text--green';
            break;
        case 2:
            title = 'Error';
            icon = 'error';
            color = 'mdl-color-text--red';
            break;
        case 3:
            title = 'Advertencia';
            icon = 'warning';
            color = 'mdl-color-text--yellow';
            break;
        case 4:
            title = 'Aviso';
            icon = 'info';
            color = 'mdl-color-text--blue';
    }
...
function sweetAlert1( type, text, url )
{
    // Se compara el tipo de mensaje a mostrar.
    switch ( type ) {
        case 1:
...
{
    // Se declara un arreglo para guardar códigos de colores.
    let color = ['rgba(125,255,212, 0.7)',
