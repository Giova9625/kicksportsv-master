...
<div class="container">
    ...
    <table class="striped">
        ...
        <thead>
            <tr>
                ...
                <th>CANTIDAD</th>
                <th>SUBTOTAL</th>
                <th class="actions-column">ACCIÓNES</th>
            </tr>
        </thead>
    ...
    <div class="row right-align">
        <button type="button" onclick="finishOrder()" class="btn waves-effect cyan darken-3 tooltipped" data-tooltip="Finalizar pedido"><i class="material-icons">payment</i></button>
    </div>
    <!-- Fila para mostrar un enlace que dirección a la página principal para seguir comprando -->
    <div class="row right-align">
        <a href="index.php" class="btn waves-effect green tooltipped" data-tooltip="Seguir comprando"><i class="material-icons">store</i></a>
    </div>
</div>
